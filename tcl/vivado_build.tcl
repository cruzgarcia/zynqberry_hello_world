...
set script_file "hello_world.tcl"
...
set files [list \
 [file normalize "${origin_dir}/../hdl/hello_world_bd/hello_world_bd.bd"] \
 [file normalize "${origin_dir}/../hdl/hello_world_bd/hdl/hello_world_bd_wrapper.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../hdl/hello_world_bd/hello_world_bd.bd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "registered_with_manager" -value "1" -objects $file_obj

set file "$origin_dir/../hdl/hello_world_bd/hdl/hello_world_bd_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "hello_world_bd_wrapper" -objects $obj
...
#write_hw_platform -fixed -force ‑include_bit "test.xsa"
# write_hw_platform -fixed -force ‑include_bit test.xsa
#write_hw_platform -fixed -include_bit test.xsa
#write_hw_platform -fixed "test.xsa"
